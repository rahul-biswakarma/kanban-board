...
import { SideNavProps } from "../libs/types/SideNav";

const Navbar: React.FC<SideNavProps> = (props) => {
	const [toggleBoardList, setToggleBoardList] = useState<boolean>(false);
				...
				<div className="flex flex-col items-center justify-between w-full h-full">
					<div className="w-full flex justify-center item-center flex-col gap-[1.5rem]">
						<button
							...
							onClick={() => setToggleBoardList(!toggleBoardList)}
						>
							<svg
